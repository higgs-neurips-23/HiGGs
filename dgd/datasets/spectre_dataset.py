...
class SpectreGraphDataset(Dataset):
    def __init__(self, data_file):
        ...
        base_path = os.path.abspath(os.path.join(os.getcwd(), '..', '..', '..',   'data', 'sbm', 'raw'))
    ...
    def __getitem__(self, idx):
        ...
        # y = torch.Tensor([1, 0]).to(torch.float)
        ...
        #                            f'graphs/real_sbm')
        # visualization_tools.visualize(result_path, g, min(15, len(g)),
        #                               log = "Real")
