...
from metrics.abstract_metrics import SumExceptBatchMetric, SumExceptBatchMSE, SumExceptBatchKL, CrossEntropyMetric, \
    ProbabilityMetric, NLL, FocalEntropyMetric, KLLMetric
...
class TrainLossDiscreteFocal(nn.Module):
    """ Train with Cross entropy"""
    def __init__(self, lambda_train):
        super().__init__()
        self.node_loss = FocalEntropyMetric()
        self.edge_loss = FocalEntropyMetric()
        self.y_loss = FocalEntropyMetric()
        self.lambda_train = lambda_train
...
class TrainLossDiscreteKL(nn.Module):
    ...
    def __init__(self, lambda_train):
        super().__init__()
        self.node_loss = KLLMetric()
        self.edge_loss = KLLMetric()
        self.y_loss = KLLMetric()
        self.lambda_train = lambda_train
